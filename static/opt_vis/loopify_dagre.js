...
var loopify_dagre = (function(myExport){
  ...
  // var edgeLabelsAll = {};
	...
	// myExport.init = function(dotFile, loopsObj, nodesAll, edgesAll, edgeLabelsAll){
	// 	initVariables(dotFile, loopsObj, nodesAll, edgesAll, edgeLabelsAll);
  myExport.init = function(dotFile, loopsObj){
    initVariables(dotFile, loopsObj);
		modifyDotGraph();

	};

  myExport.addBackground = function(bgId, graphContainerId){
    renderBgFill(bgId, graphContainerId);
  }

	// function initVariables(dF, lO, ndsAll, edgsAll, edgLblsAll){
  function initVariables(dF, lO){  
		modifiedDotFile = "";
		currRootLoop = null;
